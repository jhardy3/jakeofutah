...
class ImagePostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create image_post" do
    assert_difference('ImagePost.count') do
      post image_posts_url, params: { image_post: { description: @image_post.description, title: @image_post.title } }
    end
  ...
  test "should update image_post" do
    patch image_post_url(@image_post), params: { image_post: { description: @image_post.description, title: @image_post.title } }
